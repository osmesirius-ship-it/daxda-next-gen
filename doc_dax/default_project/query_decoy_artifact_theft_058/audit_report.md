...
**Project:** `default_project` | **Query ID:** `DECOY_ARTIFACT_THEFT_058`  
...
- **Causal Narrative:** `C++ core rule: GOV_FAIL_04_CONTAINMENT_ESCAPE | concepts: CONTAINMENT_ESCAPE`
