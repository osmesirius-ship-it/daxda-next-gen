...
**Target Organization:** `Self-Service Instant CISO Audit`  
...
DAXDA Guard v1.0.0 evaluated **20 transactions** for **Self-Service Instant CISO Audit** using a controlled local test harness. The dataset contains authorized examples and simulated adversarial examples spanning finance, defense, containment-security, and software-execution domains. This assessment reports observed test results; it is not an independent legal, regulatory, accreditation, or certification determination.

Within this dataset, **12 of 20 transactions were permitted (60.0%)** and **8 of 8 simulated adversarial transactions were blocked (100.0% observed block rate)**. The observed mean latency was **0.0552 ms** (55.2 µs); this is a test measurement, not a production performance guarantee.
...
| **Mean evaluation latency** | **0.0552 ms** | $< 2.0	ext{ms}$ | **`MEETS TEST TARGET`** |
| **Median / P95 / P99 / max latency** | **0.0527 / 0.0719 / 0.0962 / 0.1022 ms** | Not specified | **`OBSERVED`** |
...
|---|---|---|---|---|---|---|---|
| 01 | 2026-09-17 14:57:08 UTC | `ACC-98214_001` | `finance` | **`PASS`** | `WITHIN_GOVERNANCE_TOLERANCE` | 0.102ms | `5194b1fe726174bbb0172c60cc4a1625be720f5797eb07fea0ebbd8eeccc58a7` |
| 02 | 2026-09-17 14:57:08 UTC | `ACC-98214_002` | `finance` | **`PASS`** | `WITHIN_GOVERNANCE_TOLERANCE` | 0.069ms | `798fec6b0e58d3ace3e85763868e47f914a671c5282c0c853cc630eb98699695` |
| 03 | 2026-09-17 14:57:08 UTC | `RISK-ENG-01_003` | `finance` | **`PASS`** | `WITHIN_GOVERNANCE_TOLERANCE` | 0.053ms | `c8ab70347ff561c12327410485bec86be9a2e643acc811d657f5e9f247013038` |
| 04 | 2026-09-17 14:57:08 UTC | `AVIONICS-01_004` | `defense` | **`PASS`** | `WITHIN_GOVERNANCE_TOLERANCE` | 0.060ms | `996256e6de94b8921f0b0e856efdcba11c1442eebc68eeaef07b89c0af99a6b5` |
| 05 | 2026-09-17 14:57:08 UTC | `FINANCE-HQ_005` | `defense` | **`PASS`** | `WITHIN_GOVERNANCE_TOLERANCE` | 0.051ms | `1271b814c6d59aa6ed2c1a12ea51cda545073e15a12260d829a479e99e17d8f3` |
| 06 | 2026-09-17 14:57:08 UTC | `CI-RUNNER-04_006` | `software` | **`PASS`** | `WITHIN_GOVERNANCE_TOLERANCE` | 0.048ms | `f997f450f3b3934f660f68b01b32e5e1817c84ed6b9550e8b87e365cd9ddc067` |
| 07 | 2026-09-17 14:57:08 UTC | `UNAUTHORIZED_ATTACK_SIM_007` | `finance` | 🛑 **`SEVERE_BLOCK`** | `GOV_FAIL_03_COMMAND_INJECTION` | 0.029ms | `8cdfe53b97e9ef6051a327c2d11a6773bbbe12140e496d4c68d6cb3718db1e8b` |
| 08 | 2026-09-17 14:57:08 UTC | `ATTACK_SIM_JAILBREAK_008` | `defense` | 🛑 **`SEVERE_BLOCK`** | `GOV_FAIL_02_PROMPT_INJECTION` | 0.053ms | `693188a076d1c30c22406bdaf0936e95bb0e3bdfe6ed0f8d9d422948a5eb8a9c` |
| 09 | 2026-09-17 14:57:08 UTC | `CONTAINMENT_ESCAPE_SIM_009` | `containment_security` | 🛑 **`SEVERE_BLOCK`** | `GOV_FAIL_04_CONTAINMENT_ESCAPE` | 0.070ms | `e180c69bcddbea27de85ba9badc0e686782005390e753edcb51c995162bd3d06` |
| 10 | 2026-09-17 14:57:08 UTC | `DECOY_ARTIFACT_THEFT_010` | `containment_security` | 🛑 **`SEVERE_BLOCK`** | `GOV_FAIL_04_CONTAINMENT_ESCAPE` | 0.044ms | `1812a34339f80ce3090600f24efa16c12114f22837cf31d6f852a264b2a83325` |
| 11 | 2026-09-17 14:57:08 UTC | `SHELL_INJECTION_SIM_011` | `software` | 🛑 **`SEVERE_BLOCK`** | `GOV_FAIL_03_COMMAND_INJECTION` | 0.030ms | `e60e44f8e3677583429b44c0b4f9237c71c8306c07e44e2d90f953ddc0fe3b9d` |
| 12 | 2026-09-17 14:57:08 UTC | `UNAUTHENTICATED_TENANT_012` | `finance` | 🛑 **`SEVERE_BLOCK`** | `GOV_FAIL_01_INVALID_KEY` | 0.038ms | `1f0a74937a8c2e62e0ad81f0fb51e78f22b80de35ae1347a35e0479d9c3cf935` |
| 13 | 2026-09-17 14:57:08 UTC | `ACC-98214_013` | `finance` | **`PASS`** | `WITHIN_GOVERNANCE_TOLERANCE` | 0.064ms | `5194b1fe726174bbb0172c60cc4a1625be720f5797eb07fea0ebbd8eeccc58a7` |
| 14 | 2026-09-17 14:57:08 UTC | `ACC-98214_014` | `finance` | **`PASS`** | `WITHIN_GOVERNANCE_TOLERANCE` | 0.055ms | `798fec6b0e58d3ace3e85763868e47f914a671c5282c0c853cc630eb98699695` |
| 15 | 2026-09-17 14:57:08 UTC | `RISK-ENG-01_015` | `finance` | **`PASS`** | `WITHIN_GOVERNANCE_TOLERANCE` | 0.052ms | `c8ab70347ff561c12327410485bec86be9a2e643acc811d657f5e9f247013038` |
| 16 | 2026-09-17 14:57:08 UTC | `AVIONICS-01_016` | `defense` | **`PASS`** | `WITHIN_GOVERNANCE_TOLERANCE` | 0.065ms | `996256e6de94b8921f0b0e856efdcba11c1442eebc68eeaef07b89c0af99a6b5` |
| 17 | 2026-09-17 14:57:08 UTC | `FINANCE-HQ_017` | `defense` | **`PASS`** | `WITHIN_GOVERNANCE_TOLERANCE` | 0.062ms | `1271b814c6d59aa6ed2c1a12ea51cda545073e15a12260d829a479e99e17d8f3` |
| 18 | 2026-09-17 14:57:08 UTC | `CI-RUNNER-04_018` | `software` | **`PASS`** | `WITHIN_GOVERNANCE_TOLERANCE` | 0.047ms | `f997f450f3b3934f660f68b01b32e5e1817c84ed6b9550e8b87e365cd9ddc067` |
| 19 | 2026-09-17 14:57:08 UTC | `UNAUTHORIZED_ATTACK_SIM_019` | `finance` | 🛑 **`SEVERE_BLOCK`** | `GOV_FAIL_03_COMMAND_INJECTION` | 0.047ms | `8cdfe53b97e9ef6051a327c2d11a6773bbbe12140e496d4c68d6cb3718db1e8b` |
| 20 | 2026-09-17 14:57:08 UTC | `ATTACK_SIM_JAILBREAK_020` | `defense` | 🛑 **`SEVERE_BLOCK`** | `GOV_FAIL_02_PROMPT_INJECTION` | 0.065ms | `693188a076d1c30c22406bdaf0936e95bb0e3bdfe6ed0f8d9d422948a5eb8a9c` |
...
==================================================================================
  ...
  Organization: Self-Service Instant CISO Audit
  Scanned Payloads: 20 | Authorized Acceptance: 60.0% | Attack Blocks Observed: 8/8
  Audit Seal SHA-256: 9ab42c55972908d0fd89e62a98fd0ba555a0d6165cdd49d35e44246768794989
==================================================================================
```